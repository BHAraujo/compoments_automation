...
Feature: Acessar os links
      ...
      Scenario: Testar link Ok 200 - Success
              ...
              Then "sim" a pagina deve conter a mensagem "Success!!"
      ...
      Scenario: Testar link Erro 400 - Bad Request
              ...
              Then "sim" a pagina deve conter a mensagem "Bad Request!!"
              And a foto do "Spider" deve ser exibida


      Scenario: Testar link Erro 404 - Page not found
              When efetuo um clique no link "Erro 404 - Page not found"
              Then "sim" a pagina deve conter a mensagem "Page Not Found!!"
              And a foto do "Deadpoolsad" deve ser exibida


      Scenario: Testar link Erro 500 - Internal Server Error
              When efetuo um clique no link "Erro 500 - Internal Server Error"
              Then "sim" a pagina deve conter a mensagem "Internal Server Error!!"
              And a foto do "Servidor" deve ser exibida
